...
import edu.mayo.jpeg.bit12_16.dct12_16.jidctflt12_16;
import edu.mayo.jpeg.bit12_16.dct12_16.jidctfst12_16;
import edu.mayo.jpeg.bit12_16.dct12_16.jidctint12_16;
import edu.mayo.jpeg.bit12_16.dct12_16.jidctred12_16;
import edu.mayo.jpeg.bit12_16.jpeglib12_16;
import edu.mayo.jpeg.bit12_16.jutils12_16;

public abstract class idct_controller12_16
{
    public boolean PROVIDE_ISLOW_TABLES = false;

    public jidctflt12_16 idctflt = new jidctflt12_16();
    public jidctfst12_16 idctfst = new jidctfst12_16();
    public jidctint12_16 idctint = new jidctint12_16();
    public jidctred12_16 idctred = new jidctred12_16();
    ...
    public static int IFAST_SCALE_BITS;
    ...
    public jpeglib12_16.J_DCT_METHOD[] cur_method = new jpeglib12_16.J_DCT_METHOD[jpeglib12_16.MAX_COMPONENTS];

    public abstract void start_pass(jpeg_decompress_struct12_16 cinfo);

    public abstract void jinit_inverse_dct(jpeg_decompress_struct12_16 cinfo);

    //public abstract void inverse_DCT(jpeg_decompress_struct cinfo, jpeg_component_info compptr, JCOEFPTR coef_block,
    // byte[][] output_buf, JDIMENSION output_col);
    // add method signatures for fdct methods, in addition to idct (e.g. jdct8.h line 84)
    public abstract void inverse_DCT(jpeg_decompress_struct12_16 cinfo, jpeg_component_info12_16 compptr, short[] coef_block,
                                     short[][] output_buf, int output_buff_offset, int output_col, inverse_DCT_method_ptr method_ptr);
    ...
    {
        return jutils12_16.RIGHT_SHIFT((x) + (ONE << ((n) - 1)), n);
    }
