...
import edu.mayo.jpeg.bit12_16.structs12_16.jpeg_upsampler12_16;

import static edu.mayo.jpeg.bit12_16.jdcolor12_16.*;
import static edu.mayo.jpeg.bit12_16.jmorecfg12_16.*;
...
public class jdmerge12_16 extends jpeg_upsampler12_16
{
                                     ...
                                     int out_rows_avail)
    {
        ...
        for (col = cinfo.output_width >> 1; col > 0; col--)
        {
            ...
            cred = Crrtab[cr];
            cgreen = jutils12_16.RIGHT_SHIFT((int) (Cbgtab[cb] + Crgtab[cr]), SCALEBITS);
            cblue = Cbbtab[cb];
            /* Fetch 2 Y values and emit 2 pixels */
            y = inptr0[inptr0_offset++] & 0xFFFF;
            outptr[RGB_RED + outptr_offset] = range_limit[y + cred];
            outptr[RGB_GREEN + outptr_offset] = range_limit[y + cgreen];
            outptr[RGB_BLUE + outptr_offset] = range_limit[y + cblue];
            outptr_offset += RGB_PIXELSIZE; // advance 3 pixels
            y = inptr0[inptr0_offset++] & 0xFFFF;
            outptr[RGB_RED + outptr_offset] = range_limit[y + cred];
            outptr[RGB_GREEN + outptr_offset] = range_limit[y + cgreen];
            outptr[RGB_BLUE + outptr_offset] = range_limit[y + cblue];
                                     ...
                                     int out_rows_avail)
    {
        ...
        for (col = cinfo.output_width >> 1; col > 0; col--)
        {
            ...
            outptr0[RGB_RED + outptr0_offset] = range_limit[y + cred];
            outptr0[RGB_GREEN + outptr0_offset] = range_limit[y + cgreen];
            outptr0[RGB_BLUE + outptr0_offset] = range_limit[y + cblue];
            outptr0_offset += RGB_PIXELSIZE;
            y = inptr00[inptr00_offset++] & 0xFFFF;
            outptr0[RGB_RED + outptr0_offset] = range_limit[y + cred];
            outptr0[RGB_GREEN + outptr0_offset] = range_limit[y + cgreen];
            outptr0[RGB_BLUE + outptr0_offset] = range_limit[y + cblue];
            ...
            outptr1[RGB_RED + outptr1_offset] = range_limit[y + cred];
            outptr1[RGB_GREEN + outptr1_offset] = range_limit[y + cgreen];
            outptr1[RGB_BLUE + outptr1_offset] = range_limit[y + cblue];
            outptr1_offset += RGB_PIXELSIZE;
            y = inptr01[inptr01_offset++] & 0xFFFF;
            outptr1[RGB_RED + outptr1_offset] = range_limit[y + cred];
            outptr1[RGB_GREEN + outptr1_offset] = range_limit[y + cgreen];
            outptr1[RGB_BLUE + outptr1_offset] = range_limit[y + cblue];
    ...
    public void build_ycc_rgb_table(jpeg_decompress_struct12_16 cinfo)
    {
        ...
        Cr_r_tab = new int[MAXJSAMPLE + 1];
        Cb_b_tab = new int[MAXJSAMPLE + 1];
        Cr_g_tab = new long[MAXJSAMPLE + 1];
        Cb_g_tab = new long[MAXJSAMPLE + 1];
        ...
        for (i = 0, x = -CENTERJSAMPLE; i <= MAXJSAMPLE; i++, x++)
        {
            ...
            Cr_r_tab[i] = jutils12_16.RIGHT_SHIFT((int) (FIX(1.40200) * x + ONE_HALF), SCALEBITS);
            /* Cb=>B value is nearest int to 1.77200 * x */
            Cb_b_tab[i] = jutils12_16.RIGHT_SHIFT((int) (FIX(1.77200) * x + ONE_HALF), SCALEBITS);
