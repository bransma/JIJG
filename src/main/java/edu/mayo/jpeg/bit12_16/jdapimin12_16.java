        ...
        switch (cinfo.num_components)
        {
            ...
            case 3 ->
            {
                ...
                else if (cinfo.saw_Adobe_marker)
                {
                    ...
                    {
                        case 0 -> cinfo.jpeg_color_space = jpeglib12_16.J_COLOR_SPACE.JCS_RGB;
                        case 1 -> cinfo.jpeg_color_space = jpeglib12_16.J_COLOR_SPACE.JCS_YCbCr;
                        default ->
                        {
            ...
            case 4 ->
            {
                if (cinfo.saw_Adobe_marker)
                {
                    switch (cinfo.Adobe_transform)
                    {
                        case 0 -> cinfo.jpeg_color_space = jpeglib12_16.J_COLOR_SPACE.JCS_CMYK;
                        case 2 -> cinfo.jpeg_color_space = jpeglib12_16.J_COLOR_SPACE.JCS_YCCK;
                        default ->
                        {
                            cinfo.err.WARNMS1(ErrorStrings12_16.JWRN_ADOBE_XFORM, cinfo.Adobe_transform);
