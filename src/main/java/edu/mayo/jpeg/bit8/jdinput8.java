...
import edu.mayo.jpeg.bit8.structs8.jpeg_input_controller8;

import static edu.mayo.jpeg.bit8.error8.ErrorStrings8.*;
import static edu.mayo.jpeg.bit8.error8.TraceStrings8.EOI_EXPECTED;
import static edu.mayo.jpeg.bit8.jmorecfg8.BITS_IN_JSAMPLE;
import static edu.mayo.jpeg.bit8.jmorecfg8.MAX_COMPONENTS;
import static edu.mayo.jpeg.bit8.jpeglib8.JPEG_MAX_DIMENSION;
import static edu.mayo.jpeg.bit8.jpeglib8.J_CODEC_PROCESS.JPROC_LOSSLESS;
import static edu.mayo.jpeg.bit8.jpeglib8.MAX_COMPS_IN_SCAN;
...
public class jdinput8 extends jpeg_input_controller8
{
        ...
        switch (val)
        {
            case jpeglib8.JPEG_REACHED_SOS: /* Found SOS */
                ...
                else
                {
                    ...
                    {
                        cinfo.err.ERREXIT(EOI_EXPECTED); /* Oops, I wasn't expecting this! */
                    }
        ...
        /* Called once, when first SOS marker is reached */
    {
        ...
        if (cinfo.image_height > JPEG_MAX_DIMENSION ||
            ...
            cinfo.err.ERREXIT1(JERR_IMAGE_TOO_BIG, JPEG_MAX_DIMENSION);

        if (cinfo.process == JPROC_LOSSLESS)
        {
            /* If precision > compiled-in value, we must downscale */
            if (cinfo.data_precision > BITS_IN_JSAMPLE)
                cinfo.err.WARNMS2(JWRN_MUST_DOWNSCALE,
        ...
        {  /* Lossy processes */
            ...
            if (cinfo.data_precision != BITS_IN_JSAMPLE)
                cinfo.err.ERREXIT1(JERR_BAD_PRECISION, cinfo.data_precision);
        }
        ...
        {
            // throw exception
            cinfo.err.ERREXIT2(JERR_COMPONENT_COUNT, cinfo.num_components, MAX_COMPONENTS);
        }
        ...
        for (ci = 0; ci < cinfo.num_components; ci++)
        {
            ...
            {
                cinfo.err.ERREXIT(JERR_BAD_SAMPLING);
            }
        ...
        /* cinfo.comps_in_scan and cinfo.cur_comp_info[] were set from SOS marker */
    {
        ...
        else
        {
            ...
            if (cinfo.comps_in_scan <= 0 || cinfo.comps_in_scan > MAX_COMPS_IN_SCAN)
                cinfo.err.ERREXIT2(JERR_COMPONENT_COUNT, cinfo.comps_in_scan,
                        MAX_COMPS_IN_SCAN);
            ...
            for (ci = 0; ci < cinfo.comps_in_scan; ci++)
            {
                ...
                if (cinfo.data_units_in_MCU + mcublks > jpeglib8.D_MAX_DATA_UNITS_IN_MCU)
                    cinfo.err.ERREXIT(JERR_BAD_MCU_SIZE);
                while (mcublks-- > 0)
                {
