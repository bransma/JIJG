...
import static edu.mayo.jpeg.bit8.jpegint8.*;
import static edu.mayo.jpeg.bit8.jpeglib8.JPEG_SUSPENDED;
...
public class jdapistd8
{
    ...
    public boolean output_pass_setup(jpeg_decompress_struct8 cinfo)
    {
         ...
         */
        cinfo.global_state = cinfo.raw_data_out ? DSTATE_RAW_OK : jpegint8.DSTATE_SCANNING;
        return true;
    }
     ...
     public int jpeg_read_scanlines(jpeg_decompress_struct8 cinfo, byte[][] scanlines, int max_lines)
    {
        ...
        {
            cinfo.err.WARNMS(JWRN_TOO_MUCH_DATA);
            return 0;
        }
                                  ...
                                  int max_lines)
    {
        ...
        if (max_lines < lines_per_iMCU_row)
            cinfo.err.ERREXIT(JERR_BUFFER_SIZE);
