...
import edu.mayo.jpeg.bit8.jpeglib8.J_CODEC_PROCESS;
import edu.mayo.jpeg.bit8.structs8.*;

import static edu.mayo.jpeg.bit8.error8.ErrorStrings8.*;
import static edu.mayo.jpeg.bit8.jpeglib8.NUM_QUANT_TBLS;
    ...
    private void latch_quant_tables(jpeg_decompress_struct8 cinfo)
    {
        ...
        for (ci = 0; ci < cinfo.comps_in_scan; ci++)
        {
            ...
            if (qtblno < 0 || qtblno >= NUM_QUANT_TBLS || cinfo.quant_tbl_ptrs[qtblno] == null)
                cinfo.err.ERREXIT1(JERR_NO_QUANT_TABLE, qtblno);
