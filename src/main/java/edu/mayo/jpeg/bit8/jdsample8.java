...
import edu.mayo.jpeg.bit8.structs8.jpeg_upsampler8;
import edu.mayo.jpeg.bit8.structs8.jpeg_component_info8;
import edu.mayo.jpeg.bit8.structs8.jpeg_decompress_struct8;

import static edu.mayo.jpeg.bit8.error8.ErrorStrings8.JERR_CCIR601_NOTIMPL;
import static edu.mayo.jpeg.bit8.error8.ErrorStrings8.JERR_FRACT_SAMPLE_NOTIMPL;

public class jdsample8 extends jpeg_upsampler8
{
    ...
    public void start_pass_upsample(jpeg_decompress_struct8 cinfo)
    {
    ...
    public void jinit_upsampler(jpeg_decompress_struct8 cinfo)
    {
        ...
        {
           cinfo.err.ERREXIT(JERR_CCIR601_NOTIMPL);
        }
        ...
        for (ci = 0; ci < cinfo.num_components; ci++)
        {
            ...
            {
                cinfo.err.ERREXIT(JERR_FRACT_SAMPLE_NOTIMPL);
            }

            if (need_buffer)
            {
                color_buf[ci] = cinfo.mem.alloc_sarray(cinfo, (int) jutils8.jround_up(cinfo.output_width, cinfo.max_h_samp_factor),
     ...
     */
     ...
     public void fullsize_upsample(jpeg_decompress_struct8 cinfo, jpeg_component_info8 compptr,
                                   byte[][] input_data, int input_data_offset, byte[][][] output_data_ptr, int[]
    ...
    public void noop_upsample(jpeg_decompress_struct8 cinfo, jpeg_component_info8 compptr,
                              byte[][] input_data, int input_data_offset, byte[][][] output_data_ptr, int[]
                                      output_data_offset, int output_data_index)
    {
    ...
    public void int_upsample(jpeg_decompress_struct8 cinfo, jpeg_component_info8 compptr,
                             byte[][] input_data, int input_data_offset, byte[][][] output_data_ptr, int[]
                                     output_data_offset, int output_data_index)
    {
        ...
        while (outrow < cinfo.max_v_samp_factor) {
            ...
            if (v_expand > 1) {
                jutils8.jcopy_sample_rows(output_data, outrow, output_data, outrow+1,
    ...
    public void h2v1_upsample(jpeg_decompress_struct8 cinfo, jpeg_component_info8 compptr,
                              byte[][] input_data, int input_data_offset, byte[][][] output_data_ptr, int[]
                                      output_data_offset, int output_data_index)
    {
        byte[][] output_data = output_data_ptr[output_data_index];
    ...
    public void h2v2_upsample(jpeg_decompress_struct8 cinfo, jpeg_component_info8 compptr,
                              byte[][] input_data, int input_data_offset, byte[][][] output_data_ptr, int[]
                                      output_data_offset, int output_data_index)
    {
        byte[][] output_data = output_data_ptr[output_data_index];
    ...
    public void h2v1_fancy_upsample(jpeg_decompress_struct8 cinfo, jpeg_component_info8 compptr,
                                    byte[][] input_data, int input_data_offset, byte[][][] output_data_ptr, int[]
                                            output_data_offset, int output_data_index)
    {
        byte[][] output_data = output_data_ptr[output_data_index];
    ...
    public void h2v2_fancy_upsample(jpeg_decompress_struct8 cinfo, jpeg_component_info8 compptr,
                                    byte[][] input_data, int input_data_offset, byte[][][] output_data_ptr, int[]
                                            output_data_offset, int output_data_index)
    {
