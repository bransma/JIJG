...
import edu.mayo.jpeg.bit8.jutils8;
...
public class jidctfst8 extends jdct8
{
    ...
    {
        return jutils8.RIGHT_SHIFT(x, n);
    }

    public static int IRIGHT_SHIFT(int x, int shft)
    {
        return jutils8.RIGHT_SHIFT(x, shft);
    }
    ...
    public void jpeg_idct_ifast(jpeg_decompress_struct8 cinfo, jpeg_component_info8 compptr, short[] coef_block, byte[][] output_buf, int output_buff_offset,
                                int output_col)
    {
        ...
        for (ctr = 0; ctr < DCTSIZE; ctr++)
        {
            ...
            {
                /* AC terms all zero */
                byte dcval = range_limit[IDESCALE(wsptr[wsptr_offset], PASS1_BITS + 3)
                        & RANGE_MASK];
