...
import edu.mayo.jpeg.bit8.structs8.jpeg_color_deconverter8;
import edu.mayo.jpeg.bit8.structs8.jpeg_decompress_struct8;

import static edu.mayo.jpeg.bit8.error8.ErrorStrings8.JERR_BAD_J_COLORSPACE;
import static edu.mayo.jpeg.bit8.error8.ErrorStrings8.JERR_CONVERSION_NOTIMPL;
    ...
    public void jinit_color_deconverter(jpeg_decompress_struct8 cinfo)
    {
        ...
        switch (cinfo.jpeg_color_space)
        {
            case JCS_GRAYSCALE ->
            {
                ...
                {
                    cinfo.err.ERREXIT(JERR_BAD_J_COLORSPACE);
                }
            }
        ...
        switch (cinfo.out_color_space)
        {
            case JCS_GRAYSCALE ->
            {
                ...
                {
                    cinfo.err.ERREXIT(JERR_CONVERSION_NOTIMPL);
                }
            }
            case JCS_RGB ->
            {
