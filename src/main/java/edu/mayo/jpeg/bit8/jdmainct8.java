...
import edu.mayo.jpeg.bit8.structs8.jpeg_d_main_controller8;
import edu.mayo.jpeg.bit8.structs8.jpeg_decompress_struct8;

import static edu.mayo.jpeg.bit8.error8.ErrorStrings8.JERR_BAD_BUFFER_MODE;
import static edu.mayo.jpeg.bit8.error8.ErrorStrings8.JERR_NOTIMPL;
...
public class jdmainct8 extends jpeg_d_main_controller8
{
    ...
    public void alloc_funny_pointers(jpeg_decompress_struct8 cinfo)
         ...
         */
    {
         ...
         */
        xbuffer[0] = new byte[cinfo.num_components][][];//(byte[][][]) cinfo.mem.alloc_small(cinfo, cinfo.num_components * 2);// * SIZEOF(byte[][]));
        xbuffer[1] = new byte[cinfo.num_components][][];
    ...
    public void make_funny_pointers(jpeg_decompress_struct8 cinfo)
    ...
    public void set_wraparound_pointers(jpeg_decompress_struct8 cinfo)
    ...
    public void set_bottom_pointers(jpeg_decompress_struct8 cinfo)
    ...
    public void start_pass(jpeg_decompress_struct8 cinfo, jpegint8.J_BUF_MODE pass_mode)
    {
        start_pass_main(cinfo, pass_mode);
    }

    public void start_pass_main(jpeg_decompress_struct8 cinfo, jpegint8.J_BUF_MODE pass_mode)
    {
        switch (pass_mode)
        {
            case JBUF_PASS_THRU ->
            ...
            case JBUF_CRANK_DEST ->
            {
                ...
                {
                    cinfo.err.ERREXIT(JERR_BAD_BUFFER_MODE);
                }
            }
        }
    }

    public void process_data(jpeg_decompress_struct8 cinfo, byte[][] output_buf, int[] out_row_ctr, int out_rows_avail)
    {
        switch (process_data)
        {
     ...
     public void process_data_simple_main(jpeg_decompress_struct8 cinfo, byte[][] output_buf, int[] out_row_ctr, int out_rows_avail)
    {
        int rowgroups_avail;
    ...
    //                   int out_rows_avail)
    public void process_data_context_main(jpeg_decompress_struct8 cinfo, byte[][] output_buf, int[] out_row_ctr, int out_rows_avail)
    {
        /* Read input data if we haven't filled the main buffer yet */
        if (!buffer_full)
        {
     ...
     */
     public void process_data_crank_post(jpeg_decompress_struct8 cinfo, byte[][] output_buf, int[] out_row_ctr, int out_rows_avail)
     ...
     */
    public void jinit_d_main_controller(jpeg_decompress_struct8 cinfo, boolean need_full_buffer)
    {
