...
import edu.mayo.jpeg.bit8.structs8.lhd_output_ptr_info8;

import static edu.mayo.jpeg.bit8.error8.ErrorStrings8.JERR_NO_HUFF_TABLE;
    ...
    public void entropy_start_pass(jpeg_decompress_struct8 cinfo)
    {
        ...
        for (ci = 0; ci < cinfo.comps_in_scan; ci++)
        {
            ...
            if (dctbl < 0 || dctbl >= jpeglib8.NUM_HUFF_TBLS ||
                ...
                cinfo.err.ERREXIT1(JERR_NO_HUFF_TABLE, dctbl);
