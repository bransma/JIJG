...
import edu.mayo.jpeg.bit8.structs8.JQUANT_TBL8;
import edu.mayo.jpeg.bit8.structs8.idct_controller8;
import edu.mayo.jpeg.bit8.structs8.jpeg_component_info8;
import edu.mayo.jpeg.bit8.structs8.jpeg_decompress_struct8;

import static edu.mayo.jpeg.bit8.error8.ErrorStrings8.JERR_BAD_DCTSIZE;
import static edu.mayo.jpeg.bit8.error8.ErrorStrings8.JERR_NOT_COMPILED;
            ...
            switch (compptr.codec_data_unit)
            {
                case 1 ->
                {
                    if (jmorecfg8.IDCT_SCALING_SUPPORTED)
                    {
                        ...
                        method = jpeglib8.J_DCT_METHOD.JDCT_ISLOW; /* jidctred uses islow-style table */
                    }
                    ...
                    switch (cinfo.dct_method)
                    {
                        case JDCT_ISLOW ->
                        {
                            if (jmorecfg8.DCT_ISLOW_SUPPORTED)
                            {
                                ...
                                method = jpeglib8.J_DCT_METHOD.JDCT_ISLOW;
                            }
                ...
                default ->
                {
                    cinfo.err.ERREXIT1(JERR_BAD_DCTSIZE, compptr.codec_data_unit);
                }
            }
