...
import jijg.bit8.structs8.jpeg_upsampler8;
...
public class jdsample8 extends jpeg_upsampler8
{
    ...
    public void jinit_upsampler(jpeg_decompress_struct8 cinfo)
    {
        ...
        {
           cinfo.err.ERREXIT(ErrorStrings8.JERR_CCIR601_NOTIMPL);
        }
        ...
        for (ci = 0; ci < cinfo.num_components; ci++)
        {
            ...
            {
                cinfo.err.ERREXIT(ErrorStrings8.JERR_FRACT_SAMPLE_NOTIMPL);
            }
