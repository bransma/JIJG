...
public class jidctint8 extends jdct8
{
    ...
    public void jpeg_idct_islow(jpeg_decompress_struct8 cinfo, jpeg_component_info8 compptr, short[] coef_block,
                                byte[][] output_buf, int output_buff_offset,
                                int output_col)
    {
        ...
        for (ctr = 0; ctr < DCTSIZE; ctr++)
        {
            ...
            {
                /* AC terms all zero */
                byte dcval = range_limit[range_limit_offset + DESCALE(wsptr[wsptr_offset], PASS1_BITS + 3)
                        & RANGE_MASK];
