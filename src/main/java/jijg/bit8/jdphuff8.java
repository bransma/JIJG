...
public class jdphuff8 extends jdhuff8
{
    ...
    public void start_pass_phuff_decoder(jpeg_decompress_struct8 cinfo)
    {
        ...
        if (bad)
        {
            cinfo.err.ERREXIT4(ErrorStrings8.JERR_BAD_PROGRESSION, cinfo.Ss, cinfo.Se, cinfo.Ah, cinfo.Al);
        }
        ...
        for (ci = 0; ci < cinfo.comps_in_scan; ci++)
        {
            ...
            {/* AC without prior DC scan */
                cinfo.err.WARNMS2(ErrorStrings8.JWRN_BOGUS_PROGRESSION, cindex, 0);
            }
            ...
            for (coefi = cinfo.Ss; coefi <= cinfo.Se; coefi++)
            {
                ...
                if (cinfo.Ah != expected)
                    cinfo.err.WARNMS2(ErrorStrings8.JWRN_BOGUS_PROGRESSION, cindex, coefi);
                ...
                for (; k <= Se; k++)
                {
                    ...
                    if (s != 0)
                    {
                        if (s != 1)       /* size of new coef should always be 1 */
                            cinfo.err.WARNMS(ErrorStrings8.JWRN_HUFF_BAD_CODE);
