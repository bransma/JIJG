...
public abstract class jpeg_marker_reader8
{
    ...
    public jpeg_marker8 cur_marker; /* NULL if not processing a marker */
    public boolean saw_SOI; /* found SOI? */
    public boolean saw_SOF; /* found SOF? */

    public jpeg_source_mgr8 src;

    public abstract void jinit_marker_reader(jpeg_decompress_struct8 cinfo);

    public abstract void reset_marker_reader(jpeg_decompress_struct8 cinfo);
    ...
    public abstract int read_markers(jpeg_decompress_struct8 cinfo);

    public abstract boolean read_restart_marker(jpeg_decompress_struct8 cinfo);
}