...
import jijg.bit8.jpegint8.J_BUF_MODE;
import jijg.bit8.structs8.jpeg_d_post_controller8;
import jijg.bit8.structs8.jpeg_decompress_struct8;

public class jdpostct8 extends jpeg_d_post_controller8
{

    public void jinit_d_post_controller(jpeg_decompress_struct8 cinfo, boolean need_full_buffer)
    {
            ...
            if (need_full_buffer)
            {
                ...
                if (jmorecfg8.QUANT_2PASS_SUPPORTED)
                {
                    whole_image = cinfo.mem.request_virt_sarray(cinfo, false,
                            ...
                            (int) jutils8.jround_up(cinfo.output_height, strip_height), strip_height);
                }
                else
                {
    ...
    public void start_pass(jpeg_decompress_struct8 cinfo, J_BUF_MODE pass_mode)
    {
    ...
    public void post_process_data(jpeg_decompress_struct8 cinfo, byte[][][] input_buf, int[] buffer_offset,
                                  ...
                                  byte[][] output_buf, int[] out_row_ctr, int out_rows_avail)
    {
        ...
        {
            case upsample:
                cinfo.upsample.upsample(cinfo, input_buf, buffer_offset, in_row_group_ctr,
                    in_row_groups_avail, output_buf, out_row_ctr, out_rows_avail);
                break;
            case post_process_1pass:
                post_process_1pass(cinfo, input_buf, buffer_offset, in_row_group_ctr,
                    in_row_groups_avail, output_buf, out_row_ctr, out_rows_avail);
                break;
            case post_process_prepass:
                post_process_prepass(cinfo, input_buf, in_row_group_ctr,
                    in_row_groups_avail, output_buf, out_row_ctr, out_rows_avail);
                break;
            case post_process_2pass:
    ...
    public void start_pass_dpost(jpeg_decompress_struct8 cinfo, J_BUF_MODE pass_mode)
    {
        switch (pass_mode)
        {
            case JBUF_PASS_THRU:
    ...
    public void post_process_1pass(jpeg_decompress_struct8 cinfo, byte[][][] input_buf, int[] buffer_offset,
    ...
    public void post_process_prepass(jpeg_decompress_struct8 cinfo, byte[][][] input_buf, int[] in_row_group_ctr,
                                     int in_row_groups_avail, byte[][] outputbuf, int[] out_row_counter,
                                     int out_rows_avail)
    {
    ...
    public void post_process_2pass(jpeg_decompress_struct8 cinfo, byte[][][] input_buf, int[] in_row_group_ctr,
                                   int in_row_groups_avail, byte[][] outputbuf, int[] out_row_counter,
                                   int out_rows_avail)
    {
