...
import jijg.bit12_16.structs12_16.d_derived_tbl12_16;
import jijg.bit12_16.structs12_16.jpeg_component_info12_16;
import jijg.bit12_16.structs12_16.jpeg_decompress_struct12_16;
import jijg.bit12_16.structs12_16.lhd_output_ptr_info12_16;

public class jdlhuff12_16 extends jdhuff12_16
{
    public d_derived_tbl12_16[] derived_tbls = new d_derived_tbl12_16[jpeglib12_16.NUM_HUFF_TBLS];
    public d_derived_tbl12_16[] cur_tbls = new d_derived_tbl12_16[jpeglib12_16.NUM_HUFF_TBLS];

    public int[][] output_ptr = new int[jpeglib12_16.D_MAX_DATA_UNITS_IN_MCU][];
    public int num_output_ptrs = 0;

    public lhd_output_ptr_info12_16[] output_ptr_info = new lhd_output_ptr_info12_16[jpeglib12_16.D_MAX_DATA_UNITS_IN_MCU];
    public int[] output_ptr_index = new int[jpeglib12_16.D_MAX_DATA_UNITS_IN_MCU];
    ...
    public void entropy_start_pass(jpeg_decompress_struct12_16 cinfo)
    {
        ...
        for (ci = 0; ci < cinfo.comps_in_scan; ci++)
        {
            ...
            if (dctbl < 0 || dctbl >= jpeglib12_16.NUM_HUFF_TBLS ||
                    cinfo.dc_huff_tbl_ptrs[dctbl] == null)
                cinfo.err.ERREXIT1(ErrorStrings12_16.JERR_NO_HUFF_TABLE, dctbl);
        ...
        for (sampn = 0, ptrn = 0; sampn < cinfo.data_units_in_MCU; )
        {
            ...
            for (yoffset = 0; yoffset < compptr.MCU_height; yoffset++, ptrn++)
            {
                ...
                {
                    output_ptr_info[ptrn] = new lhd_output_ptr_info12_16();
                }
    ...
    public int decode_mcus(jpeg_decompress_struct12_16 cinfo,
                           int[][][] diff_buf,
                           int MCU_row_num,
                           int MCU_col_num,
                           int nMCU)
    {
        ...
        int[] output_ptr_offset = new int[jpeglib12_16.D_MAX_DATA_UNITS_IN_MCU];
        ...
        if (!insufficient_data)
        {
            ...
            for (mcu_num = 0; mcu_num < nMCU; mcu_num++)
            {
                ...
                {
                    d_derived_tbl12_16 dctbl = cur_tbls[sampn];
                    int r;
