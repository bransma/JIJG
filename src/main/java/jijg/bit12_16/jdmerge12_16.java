...
import jijg.bit12_16.structs12_16.jpeg_upsampler12_16;
 ...
 */
public class jdmerge12_16 extends jpeg_upsampler12_16
{
    @Override
    ...
    private void start_pass_merged_upsample(jpeg_decompress_struct12_16 cinfo)
    {
        spare_full = false;
    ...
    public void jinit_upsampler(jpeg_decompress_struct12_16 cinfo)
    {
        ...
        if (cinfo.max_v_samp_factor == 2)
        {
            ...
            spare_row = new short[out_row_width];
        }
        else
        {
                         ...
                         int out_rows_avail)
    {
        switch (upmethod)
        {
            case h2v1_merged_upsample:
                h2v1_merged_upsample(cinfo, input_buf, in_row_group_ctr, in_row_groups_avail,
                    outputbuf, out_row_counter, out_rows_avail);
                break;
            case h2v2_merged_upsample:
                h2v2_merged_upsample(cinfo, input_buf, in_row_group_ctr, in_row_groups_avail,
                    outputbuf, out_row_counter, out_rows_avail);
                break;
        }
    }
     ...
     */
    public void merged_1v_upsample(jpeg_decompress_struct12_16 cinfo, short[][][] input_buf, int[] in_row_group_ctr,
                                   int in_row_groups_avail, short[][] outputbuf, int[] out_row_counter,
                                   int out_rows_avail)
    ...
    public void merged_2v_upsample(jpeg_decompress_struct12_16 cinfo, short[][][] input_buf, int[] in_row_group_ctr,
                                   int in_row_groups_avail, short[][] outputbuf, int[] out_row_counter,
                                   int out_rows_avail)
        /* 2:1 vertical sampling case: may need a spare row. */
    {
        short[][] work_ptrs = new short[2][];
    ...
    public void h2v1_merged_upsample(jpeg_decompress_struct12_16 cinfo, short[][][] input_buf, int[] in_row_group_ctr,
                                     int in_row_groups_avail, short[][] outputbuf, int[] out_row_counter,
                                     int out_rows_avail)
    {
        ...
        for (col = cinfo.output_width >> 1; col > 0; col--)
        {
            ...
            cb = inptr1[inptr1_offset++] & 0xFFFF;
            cr = inptr2[inptr2_offset++] & 0xFFFF;
            cred = Crrtab[cr];
            cgreen = jutils12_16.RIGHT_SHIFT((int) (Cbgtab[cb] + Crgtab[cr]), jdcolor12_16.SCALEBITS);
            cblue = Cbbtab[cb];
            /* Fetch 2 Y values and emit 2 pixels */
            y = inptr0[inptr0_offset++] & 0xFFFF;
            outptr[jmorecfg12_16.RGB_RED + outptr_offset] = range_limit[y + cred];
            outptr[jmorecfg12_16.RGB_GREEN + outptr_offset] = range_limit[y + cgreen];
            outptr[jmorecfg12_16.RGB_BLUE + outptr_offset] = range_limit[y + cblue];
            outptr_offset += jmorecfg12_16.RGB_PIXELSIZE; // advance 3 pixels
            y = inptr0[inptr0_offset++] & 0xFFFF;
            outptr[jmorecfg12_16.RGB_RED + outptr_offset] = range_limit[y + cred];
            outptr[jmorecfg12_16.RGB_GREEN + outptr_offset] = range_limit[y + cgreen];
            outptr[jmorecfg12_16.RGB_BLUE + outptr_offset] = range_limit[y + cblue];
     ...
     */
    public void h2v2_merged_upsample(jpeg_decompress_struct12_16 cinfo, short[][][] input_buf, int[] in_row_group_ctr,
                                     int in_row_groups_avail, short[][] outputbuf, int[] out_row_counter,
                                     int out_rows_avail)
    {
        int y, cred, cgreen, cblue;
        int cb, cr;
        short[] outptr0, outptr1;
        short[] inptr00, inptr01, inptr1, inptr2;
        int col;
        /* copy these pointers into registers if possible */
        short[] range_limit = cinfo.sample_range_limit;
        int[] Crrtab = Cr_r_tab;
        ...
        for (col = cinfo.output_width >> 1; col > 0; col--)
        {
            ...
            y = inptr00[inptr00_offset++] & 0xFFFF;
            outptr0[jmorecfg12_16.RGB_RED + outptr0_offset] = range_limit[y + cred];
            outptr0[jmorecfg12_16.RGB_GREEN + outptr0_offset] = range_limit[y + cgreen];
            outptr0[jmorecfg12_16.RGB_BLUE + outptr0_offset] = range_limit[y + cblue];
            outptr0_offset += jmorecfg12_16.RGB_PIXELSIZE;
            y = inptr00[inptr00_offset++] & 0xFFFF;
            outptr0[jmorecfg12_16.RGB_RED + outptr0_offset] = range_limit[y + cred];
            outptr0[jmorecfg12_16.RGB_GREEN + outptr0_offset] = range_limit[y + cgreen];
            outptr0[jmorecfg12_16.RGB_BLUE + outptr0_offset] = range_limit[y + cblue];
            outptr0_offset += jmorecfg12_16.RGB_PIXELSIZE;
            y = inptr01[inptr01_offset++] & 0xFFFF;
            outptr1[jmorecfg12_16.RGB_RED + outptr1_offset] = range_limit[y + cred];
            outptr1[jmorecfg12_16.RGB_GREEN + outptr1_offset] = range_limit[y + cgreen];
            outptr1[jmorecfg12_16.RGB_BLUE + outptr1_offset] = range_limit[y + cblue];
            outptr1_offset += jmorecfg12_16.RGB_PIXELSIZE;
            y = inptr01[inptr01_offset++] & 0xFFFF;
            outptr1[jmorecfg12_16.RGB_RED + outptr1_offset] = range_limit[y + cred];
            outptr1[jmorecfg12_16.RGB_GREEN + outptr1_offset] = range_limit[y + cgreen];
            outptr1[jmorecfg12_16.RGB_BLUE + outptr1_offset] = range_limit[y + cblue];
        ...
        if ((cinfo.output_width & 1) != 0)
        {
            ...
            cblue = Cbbtab[cb];
            y = inptr00[inptr00_offset] & 0xFFFF;
            outptr0[jmorecfg12_16.RGB_RED] = range_limit[y + cred];
            outptr0[jmorecfg12_16.RGB_GREEN] = range_limit[y + cgreen];
            outptr0[jmorecfg12_16.RGB_BLUE] = range_limit[y + cblue];
            y = inptr01[inptr01_offset] & 0xFFFF;
            outptr1[jmorecfg12_16.RGB_RED] = range_limit[y + cred];
            outptr1[jmorecfg12_16.RGB_GREEN] = range_limit[y + cgreen];
            outptr1[jmorecfg12_16.RGB_BLUE] = range_limit[y + cblue];
        }
    }
    ...
    public void build_ycc_rgb_table(jpeg_decompress_struct12_16 cinfo)
    {
        ...
        for (i = 0, x = -jmorecfg12_16.CENTERJSAMPLE; i <= jmorecfg12_16.MAXJSAMPLE; i++, x++)
        {
            ...
            Cr_r_tab[i] = jutils12_16.RIGHT_SHIFT((int) (jdcolor12_16.FIX(1.40200) * x + jdcolor12_16.ONE_HALF), jdcolor12_16.SCALEBITS);
            /* Cb=>B value is nearest int to 1.77200 * x */
            Cb_b_tab[i] = jutils12_16.RIGHT_SHIFT((int) (jdcolor12_16.FIX(1.77200) * x + jdcolor12_16.ONE_HALF), jdcolor12_16.SCALEBITS);
            /* Cr=>G value is scaled-up -0.71414 * x */
            Cr_g_tab[i] = (-jdcolor12_16.FIX(0.71414)) * x;
            /* Cb=>G value is scaled-up -0.34414 * x */
            /* We also add in ONE_HALF so that need not do it in inner loop */
            Cb_g_tab[i] = (-jdcolor12_16.FIX(0.34414)) * x + jdcolor12_16.ONE_HALF;
        }
    }
}
