...
public class jdpred12_16
{
    ...
    {
        return (Ra + jutils12_16.RIGHT_SHIFT(Rb - Rc, 1));
    }

    public int PREDICTOR6()
    {
        return (Rb + jutils12_16.RIGHT_SHIFT(Ra - Rc, 1));
    }

    public int PREDICTOR7()
    {
        return jutils12_16.RIGHT_SHIFT(Ra + Rb, 1);
    }
    ...
    public void jpeg_undifference1(jpeg_decompress_struct12_16 cinfo, int comp_index,
    ...
    public void jpeg_undifference2(jpeg_decompress_struct12_16 cinfo, int comp_index,
                                   int[] diff_buf, int[] prev_row,
                                   int[] undiff_buf, int width)
    {
    ...
    public void jpeg_undifference3(jpeg_decompress_struct12_16 cinfo, int comp_index,
                                   int[] diff_buf, int[] prev_row,
                                   int[] undiff_buf, int width)
    {
    ...
    public void jpeg_undifference4(jpeg_decompress_struct12_16 cinfo, int comp_index,
                                   int[] diff_buf, int[] prev_row,
                                   int[] undiff_buf, int width)
    {
    ...
    public void jpeg_undifference5(jpeg_decompress_struct12_16 cinfo, int comp_index,
                                   int[] diff_buf, int[] prev_row,
                                   int[] undiff_buf, int width)
    {
    ...
    public void jpeg_undifference6(jpeg_decompress_struct12_16 cinfo, int comp_index,
                                   int[] diff_buf, int[] prev_row,
                                   int[] undiff_buf, int width)
    {
    ...
    public void jpeg_undifference7(jpeg_decompress_struct12_16 cinfo, int comp_index,
                                   int[] diff_buf, int[] prev_row,
                                   int[] undiff_buf, int width)
    {
    ...
    public void jpeg_undifference_first_row(jpeg_decompress_struct12_16 cinfo, int comp_index,
                                            int[] diff_buf, int[] prev_row,
                                            int[] undiff_buf, int width)
    {
        jdlossls12_16 losslsd = (jdlossls12_16) cinfo.codec;
        ...
        {
            case 1:
                losslsd.predict_undifference[comp_index] = predict_undifference.jpeg_undifference1;
                break;
            case 2:
                losslsd.predict_undifference[comp_index] = predict_undifference.jpeg_undifference2;
                break;
            case 3:
                losslsd.predict_undifference[comp_index] = predict_undifference.jpeg_undifference3;
                break;
            case 4:
                losslsd.predict_undifference[comp_index] = predict_undifference.jpeg_undifference4;
                break;
            case 5:
                losslsd.predict_undifference[comp_index] = predict_undifference.jpeg_undifference5;
                break;
            case 6:
                losslsd.predict_undifference[comp_index] = predict_undifference.jpeg_undifference6;
                break;
            case 7:
                losslsd.predict_undifference[comp_index] = predict_undifference.jpeg_undifference7;
                break;
        }
    }
    ...
    public void predict_start_pass(jpeg_decompress_struct12_16 cinfo)
    {
        ...
        if (cinfo.Ss < 1 || cinfo.Ss > 7 ||
            ...
            cinfo.err.WARNMS3(ErrorStrings12_16.JERR_BAD_LOSSLESS, cinfo.Ss, cinfo.Se, cinfo.Ah, cinfo.Al);
