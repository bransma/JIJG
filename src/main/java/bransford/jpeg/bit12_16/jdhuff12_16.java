...
public abstract class jdhuff12_16
{
     ...
     */
    public bitread_perm_state12_16 bitstate = new bitread_perm_state12_16(); /* Bit buffer at start of MCU */

    public savable_state12_16 saved = new savable_state12_16(); /* Other state at start of MCU */

    // Equivalent to BITREAD_STATE_VARS
    public bitread_working_state12_16 br_state = new bitread_working_state12_16();
    ...
    public abstract boolean process_restart(jpeg_decompress_struct12_16 cinfo);

    public abstract void entropy_start_pass(jpeg_decompress_struct12_16 cinfo);

    /* the various decode methods for jd*huff */
    public abstract boolean entropy_decode_mcu(jpeg_decompress_struct12_16 cinfo, short[][] MCU_data);

    public void jpeg_make_d_derived_tbl(jpeg_decompress_struct12_16 cinfo, boolean isDC, int tblno, d_derived_tbl12_16[] dtbl)
    {
        JHUFF_TBL12_16 htbl;
        ...
        if (tblno < 0 || tblno >= jpeglib12_16.NUM_HUFF_TBLS)
        {
            cinfo.err.ERREXIT1(ErrorStrings12_16.JERR_NO_HUFF_TABLE, tblno);
        }
        ...
        if (dtbl[tblno] == null)
        {
            dtbl[tblno] = new d_derived_tbl12_16();
        }
    ...
    public boolean jpeg_fill_bit_buffer(int nbits)
    {
        ...
        jpeg_decompress_struct12_16 cinfo = br_state.cinfo;
    ...
    public int jpeg_huff_decode(d_derived_tbl12_16 htbl, int min_bits)
    {
        int l = min_bits;
        long code;
        ...
        if (l > 16)
        {
            if (br_state.cinfo != null)
                br_state.cinfo.err.WARNMS(ErrorStrings12_16.JWRN_HUFF_BAD_CODE);
    ...
    public final void BITREAD_LOAD_STATE(jpeg_decompress_struct12_16 cinfo, bitread_perm_state12_16 bitstate)
    {
    ...
    public final void BITREAD_SAVE_STATE(jpeg_decompress_struct12_16 cinfo, bitread_perm_state12_16 bitstate)
    {
    ...
    public final void ASSIGN_STATE(savable_state12_16 dest, savable_state12_16 src)
    {
    ...
    public final boolean HUFF_DECODE(d_derived_tbl12_16 htbl)
    {
        int nb = 0, look;
    ...
    private void slowlable(d_derived_tbl12_16 htbl, int nb)
    {
    ...
    private boolean no_more_bytes(jpeg_decompress_struct12_16 cinfo, int nbits)
    {
        if (nbits > bits_left)
        {
             ...
             */
            jdhuff12_16 huffd = cinfo.codec.entropy_private;

            if (!huffd.insufficient_data)
            {
                cinfo.err.WARNMS(ErrorStrings12_16.JWRN_HIT_MARKER);
