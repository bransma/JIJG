...
import bransford.jpeg.bit12_16.structs12_16.jpeg_color_quantizer12_16;
...
public class jquant2_12_16 extends jpeg_color_quantizer12_16
{
    /*
    ...
    public static final int MAXNUMCOLORS = (jmorecfg12_16.MAXJSAMPLE + 1); /* maximum size of colormap */
    ...
    public static final int C0_SHIFT = (jmorecfg12_16.BITS_IN_JSAMPLE - HIST_C0_BITS);
    public static final int C1_SHIFT = (jmorecfg12_16.BITS_IN_JSAMPLE - HIST_C1_BITS);
    public static final int C2_SHIFT = (jmorecfg12_16.BITS_IN_JSAMPLE - HIST_C2_BITS);
    ...
    public jquant2_12_16()
    {
        if (jmorecfg12_16.RGB_RED == 0)
        {
            C0_SCALE = R_SCALE;
        }
        if (jmorecfg12_16.RGB_BLUE == 0)
        {
            C0_SCALE = B_SCALE;
        }
        if (jmorecfg12_16.RGB_GREEN == 1)
        {
            C1_SCALE = G_SCALE;
        }
        if (jmorecfg12_16.RGB_RED == 2)
        {
            C2_SCALE = R_SCALE;
        }
        if (jmorecfg12_16.RGB_BLUE == 2)
        {
            C2_SCALE = B_SCALE;
        }
    }

    public void prescan_quantize(jpeg_decompress_struct12_16 cinfo, short[][] input_buf, short[][] output_buf, int num_rows)
    {
    ...
    public void update_box(jpeg_decompress_struct12_16 cinfo, box1 boxp)
    ...
    public int median_cut(jpeg_decompress_struct12_16 cinfo, box1 boxlist, int numboxes, int desired_colors)
    ...
    public void compute_color(jpeg_decompress_struct12_16 cinfo, box1 boxp, int icolor)
    ...
    public void select_colors(jpeg_decompress_struct12_16 cinfo, int desired_colors)
    ...
    public int find_nearby_colors(jpeg_decompress_struct12_16 cinfo, int minc0, int minc1, int minc2, byte[] colorlist)
    ...
    public void find_best_colors(jpeg_decompress_struct12_16 cinfo, int minc0, int minc1, int minc2, int numcolors, byte[] colorlist,
                                 byte[] bestcolor)
    ...
    public void fill_inverse_cmap(jpeg_decompress_struct12_16 cinfo, int c0, int c1, int c2)
    ...
    public void pass2_no_dither(jpeg_decompress_struct12_16 cinfo, short[][] input_buf, short[][] output_buf, int num_rows)
        /* This version performs no dithering */
    {

    }

    public void pass2_fs_dither(jpeg_decompress_struct12_16 cinfo, short[][] input_buf, short[][] output_buf, int num_rows)
    ...
    public void init_error_limit(jpeg_decompress_struct12_16 cinfo)
        /* Allocate and fill in the error_limiter table */
    {
        ...
        table = new int[jmorecfg12_16.MAXJSAMPLE * 2 + 1];
        //	    (int *) (*cinfo->mem->alloc_small)
        //	    ((j_common_ptr) cinfo, JPOOL_IMAGE, (MAXJSAMPLE*2+1) * SIZEOF(int));
        index += jmorecfg12_16.MAXJSAMPLE; /* so can index -MAXJSAMPLE .. +MAXJSAMPLE */
        error_limiter = table;

        int STEPSIZE = ((jmorecfg12_16.MAXJSAMPLE + 1) / 16);
        ...
        for (; in <= jmorecfg12_16.MAXJSAMPLE; in++)
        {
            table[in] = out;
            table[-in] = -out;
        }
    ...
    public void finish_pass1(jpeg_decompress_struct12_16 cinfo)
    {
    ...
    public void finish_pass2(jpeg_decompress_struct12_16 cinfo)
    {
        /* no work */
    }
    ...
    public void start_pass_2_quant(jpeg_decompress_struct12_16 cinfo, boolean is_pre_scan)
    {
    ...
    public void new_color_map_2_quant(jpeg_decompress_struct12_16 cinfo)
    {
        //my_cquantize_ptr cquantize = (my_cquantize_ptr) cinfo.cquantize;
    ...
    public void jinit_pass_quantizer(jpeg_decompress_struct12_16 cinfo)
    {
        ...
        if (cinfo.dither_mode != jpeglib12_16.J_DITHER_MODE.JDITHER_NONE)
