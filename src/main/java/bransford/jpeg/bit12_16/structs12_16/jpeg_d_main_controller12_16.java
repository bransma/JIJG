...
import bransford.jpeg.bit12_16.jpegint12_16;
import bransford.jpeg.bit12_16.jpeglib12_16;

public abstract class jpeg_d_main_controller12_16
{
    /* Pointer to allocated workspace (M or M+2 row groups). */
    // public byte[][][] buffer = new byte[jpeglib.MAX_COMPONENTS][][];//JSAMPARRAY buffer[jpeglib.MAX_COMPONENTS];
    public short[][][] buffer = new short[jpeglib12_16.MAX_COMPONENTS][][];
    public int[] buffer_offset = new int[jpeglib12_16.MAX_COMPONENTS]; // in leui of pointer arthimatic
    ...
    public short[][][][] xbuffer = new short[2][][][];
...
//    public abstract void process_data(jpeg_decompress_struct cinfo, byte[][] output_buf, int[] out_row_ctr, int out_rows_avail);
//
//    public abstract void process_data_simple_main(jpeg_decompress_struct cinfo, byte[][] output_buf, int[] out_row_ctr,
//                                                  int out_rows_avail);
//
//    public abstract void process_data_context_main(jpeg_decompress_struct cinfo, byte[][] output_buf, int[] out_row_ctr,
//                                                   int out_rows_avail);
//
//    public abstract void process_data_crank_post(jpeg_decompress_struct cinfo, byte[][] output_buf, int[] out_row_ctr,
//                                                 int out_rows_avail);
    public abstract void process_data(jpeg_decompress_struct12_16 cinfo, short[][] output_buf, int[] out_row_ctr, int out_rows_avail);

    public abstract void process_data_simple_main(jpeg_decompress_struct12_16 cinfo, short[][] output_buf, int[] out_row_ctr,
                                                  int out_rows_avail);

    public abstract void process_data_context_main(jpeg_decompress_struct12_16 cinfo, short[][] output_buf, int[] out_row_ctr,
                                                   int out_rows_avail);

    public abstract void process_data_crank_post(jpeg_decompress_struct12_16 cinfo, short[][] output_buf, int[] out_row_ctr,
                                                 int out_rows_avail);

    /*
     * Initialize main buffer controller.
     */
    public abstract void jinit_d_main_controller(jpeg_decompress_struct12_16 cinfo, boolean need_full_buffer);
}
