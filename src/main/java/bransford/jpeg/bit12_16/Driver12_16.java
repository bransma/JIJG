...
import bransford.jpeg.bit12_16.structs12_16.jpeg_source_mgr12_16;
...
public class Driver12_16
{
    ...
    public byte[][] decompress12_16(byte[][] inmemory, jpeglib12_16.J_COLOR_SPACE photometricInterpretation, ArrayList<HashMap<String, Integer>> imageCharacteristics)
    {
        ...
        for (byte[] pixels: inmemory)
        {
            ...
            imageData[i] = decompress12_16(pixels, photometricInterpretation, characteristics);
