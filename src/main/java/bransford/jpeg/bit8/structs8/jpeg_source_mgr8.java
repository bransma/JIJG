...
public class jpeg_source_mgr8
{
    ...
    public jpeg_source_mgr8(byte[] src)
    {
        this.byteBuffer = src;
    ...
    public void term_source(jpeg_decompress_struct8 cinfo)
    {
        // no-op
    }

    public void resync_to_restart(jpeg_decompress_struct8 cinfo, int desired)
    {
        // no-op
    }

    public boolean fill_input_buffer(jpeg_decompress_struct8 cinfo)
    {
        //no-op b/c using a full in-memory buffer
        return true;
    }

    public void init_source(jpeg_decompress_struct8 cinfo)
    {
