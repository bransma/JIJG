...
import bransford.jpeg.bit8.jpegint8;
import bransford.jpeg.bit8.jpeglib8;

import java.util.ArrayList;

public class jpeg_decompress_struct8
{
    ...
    public int global_state = jpegint8.DSTATE_START; /* For checking call sequence validity */
    ...
    public jpeglib8.J_COLOR_SPACE jpeg_color_space; /* colorspace of JPEG image */
    ...
    public jpeglib8.J_COLOR_SPACE out_color_space; /* colorspace for output */
    ...
    public jpeglib8.J_DCT_METHOD dct_method; /* IDCT algorithm selector */
    ...
    public jpeglib8.J_DITHER_MODE dither_mode; /* type of color dithering to use */
    ...
    public JQUANT_TBL8[] quant_tbl_ptrs = new JQUANT_TBL8[jpeglib8.NUM_QUANT_TBLS];
    /* ptrs to coefficient quantization tables, or null if not defined */

    public JHUFF_TBL8[] dc_huff_tbl_ptrs = new JHUFF_TBL8[jpeglib8.NUM_HUFF_TBLS];
    public JHUFF_TBL8[] ac_huff_tbl_ptrs = new JHUFF_TBL8[jpeglib8.NUM_HUFF_TBLS];
    ...
    public jpeg_component_info8[] comp_info;
    /* comp_info[i] describes component that appears i'th in SOF */

    public boolean arith_code; /* TRUE=arithmetic coding, FALSE=Huffman */

    public byte[] arith_dc_L = new byte[jpeglib8.NUM_ARITH_TBLS]; /* L values for DC arith-coding tables */
    public byte[] arith_dc_U = new byte[jpeglib8.NUM_ARITH_TBLS]; /* U values for DC arith-coding tables */
    public byte[] arith_ac_K = new byte[jpeglib8.NUM_ARITH_TBLS]; /* Kx values for AC arith-coding tables */
     ...
     */
    public ArrayList<jpeg_marker8> marker_list = new ArrayList<jpeg_marker8>(); /* jpeg_saved_marker_ptr: Head of list of saved markers */
    ...
    public jpeglib8.J_CODEC_PROCESS process; /* decoding process of JPEG image */
    ...
    public jpeg_component_info8[] cur_comp_info = new jpeg_component_info8[jpeglib8.MAX_COMPS_IN_SCAN];
    ...
    public int[] MCU_membership = new int[jpeglib8.D_MAX_DATA_UNITS_IN_MCU];
     ...
     */
    public jpeg_decomp_master8 master; // not yet implemented and/or wired in
    public jpeg_d_main_controller8 main; // not yet implemented and/or wired in

    // These are the types of decompression routines;
    public jpeg_d_codec8 codec; // not yet implemented and/or wired in

    public jpeg_d_post_controller8 post; // not yet implemented and/or wired in
    public jpeg_input_controller8 inputctl;
    public jpeg_marker_reader8 marker;

    // This must be an abstract class, implemented by jdmerge and jdsample
    public jpeg_upsampler8 upsample; // not yet implemented and/or wired in

    public jpeg_color_deconverter8 cconvert; // not yet implemented and/or wired in
    public jpeg_color_quantizer8 cquantize; // not yet implemented and/or wired in

    public jpeg_progress_mgr8 progress; // not yet implemented and/or wired in (and seems to be null?)

    // wrapper for the input data
    public jpeg_source_mgr8 src;

    // memory manager, (methods are no-op's?) keep to have the code read like DCMTK/IJG
    public jpeg_memory_mgr8 mem;

    // error manager
    public jpeg_error_mgr8 err;
}
